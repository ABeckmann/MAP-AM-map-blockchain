...
# PAYLOAD_SEARIALISATION = action, name_id, owner, new_owner, usage, value, signed_value, remove_signed_value, repairs,
#                          security_tag_public_key, parent, child, blueprint, list_of_blueprint_connections
